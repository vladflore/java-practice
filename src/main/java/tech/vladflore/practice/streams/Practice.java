...
//        System.out.println(productList.stream().collect(Collectors.summingInt(Product::price)));
        System.out.println((Integer) productList.stream().mapToInt(Product::price).sum());
        ...
        // two new collectors added in Java 9: Collectors.filtering and Collectors.flatMapping
        ...
        System.out.println(bookList.stream().collect(
            Collectors.toMap(
                Book::releaseYear, Function.identity(), (existing, replacement) -> existing
            )));
